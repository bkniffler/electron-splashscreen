...
<head>
  ...
  <style>
    ...
    .container .subcontainer .half:nth-child(1) .droplet:after {
      background-image: url("data:image/svg+xml;utf8,<svg viewBox='0 0 10 10' xmlns='http://www.w3.org/2000/svg'><path fill='#5db0c9' d='M0,10L5,0L10,10Z'/></svg>");
